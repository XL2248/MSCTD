...
filepath_w_ch = './'+typ+'_zh.txt'
filepath_w_en_ctx = './'+typ+'_en_ctx.txt'
filepath_w_ch_ctx = './'+typ+'_zh_ctx.txt'
filepath_w_en_ctx_src = './'+typ+'_en_ctx_src.txt'
filepath_w_ch_ctx_src = './'+typ+'_zh_ctx_src.txt'
filepath_w_chen_ctx = './'+ typ+'_en_sample.txt'
filepath_w_chper_ctx = './'+ typ+'_zh_sample.txt'
...
for idx in range(start, end):
    #en_filename = "english_%s.txt.norm.tok.lowercase.bpe"%typ
    en_filename = "english_%s.txt.norm.tok.lowercase.bpe.32k"%typ
#    zh_filename = "chinese_%s_zh_seg.txt.norm.bpe"%typ
    zh_filename = "chinese_%s_zh_seg.txt.norm.bpe.32k"%typ
