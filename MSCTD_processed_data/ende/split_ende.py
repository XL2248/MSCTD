...
#with open():
#typ="test"
f1="../bpe_ende/%s_en_ctx_src.txt"%typ
f2="../bpe_ende/%s_en_ctx.txt"%typ
f3="../bpe_ende/%s_en_sample.txt"%typ
f4="../bpe_ende/%s_en.txt"%typ
f5="../bpe_ende/%s_image_idx.txt"%typ
f6="../bpe_ende/%s_de_ctx_src.txt"%typ
f7="../bpe_ende/%s_de_ctx.txt"%typ
f8="../bpe_ende/%s_de_sample.txt"%typ
f9="../bpe_ende/%s_de.txt"%typ
f_1="%s_en_ctx_src.txt"%typ
f_2="%s_en_ctx.txt"%typ
f_3="%s_en_sample.txt"%typ
f_4="%s_en.txt"%typ
f_5="%s_image_idx.txt"%typ
f_6="%s_de_ctx_src.txt"%typ
f_7="%s_de_ctx.txt"%typ
f_8="%s_de_sample.txt"%typ
f_9="%s_de.txt"%typ
