...
#        context_dia_tgt = transformer_context(context_input, ctx_attn_bias, params)
    ...
    if mode == "infer":
        dia_mask = top_mask
        return encoder_output, context_dia_src, context_dia_tgt, context_source, turn_dia_src_pos_emb, turn_dia_tgt_pos_emb, turn_ctx_src_pos_emb, first_layer_output, sa_tgt, dia_mask

    return encoder_output, context_dia_src, context_dia_tgt, context_source, turn_dia_src_pos_emb, turn_dia_tgt_pos_emb, turn_ctx_src_pos_emb, first_layer_output, sa_tgt, top_mask
...
def model_graph(features, mode, params):
    encoder_output, context_dia_src, context_dia_tgt, context_source, turn_dia_src_pos_emb, turn_dia_tgt_pos_emb, turn_ctx_src_pos_emb, first_layer_output, sample_output, dia_mask = encoding_graph(features, mode, params)
    state = {
...
class Transformer(NMTModel):
    ...
    def get_inference_func(self):
        def encoding_fn(features, params=None):
            ...
            with tf.variable_scope(self._scope):
                encoder_output, context_dia_src, context_dia_tgt, context_source, turn_dia_src_pos_emb, turn_dia_tgt_pos_emb, turn_ctx_src_pos_emb, first_layer_output, sample_output, dia_mask = encoding_graph(features, "infer", params)
