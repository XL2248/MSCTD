...
def override_parameters(params, args):
    ...
    params.vocabulary = {
        ...
        "index": vocabulary.load_vocabulary(args.vocabulary[2])
    }
...
def main(args):
    ...
    with tf.Graph().as_default():
        ...
        # Read input file
        sorted_keys, sorted_inputs, valid_index = dataset.sort_input_file(args.input, args.valid_index)
        ...
        img, img_mask = [], []
        print("valid_index", len(valid_index), valid_index[0], valid_index[-1])
