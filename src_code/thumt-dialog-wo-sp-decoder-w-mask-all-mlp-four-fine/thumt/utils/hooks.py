...
def _evaluate(eval_fn, input_fn, decode_fn, path, config):
    ...
    with graph.as_default():
        ...
        placeholders = {
            ...
            "image": tf.placeholder(tf.float32, [None, 2, 2048], "image"),
            "image_mask": tf.placeholder(tf.float32, [None, 2], "image_mask"),
        ...
        with tf.train.MonitoredSession(session_creator=sess_creator) as sess:
            while not sess.should_stop():
                ...
                outputs = sess.run(predictions, feed_dict={
                    ...
                    placeholders["image"]: feats["image"],
                    placeholders["image_mask"]: feats["image_mask"],
